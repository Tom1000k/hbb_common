...
pub const LINK_DOCS_HOME: &str = "https://rustdesk.com/docs/";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["oplatyogrodowe.pl"];
pub const RS_PUB_KEY: &str = "rx+3dpm4S3E2E+rxWUglqXnjDwqbRTRaMm0sSL+AzVA=";
